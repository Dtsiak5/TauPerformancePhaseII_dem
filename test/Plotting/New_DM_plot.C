...
void New_DM_plot(){
  ...
  TString fileName1 = "../new_store/TwoTaus_ggH_PU200_Demetra.root"; // /afs/cern.ch/work/d/dtsiakko/private/CMSSW_9_4_2_tauAtMiniAOD/src/RecoTauTag/Configuration/test/RelValZTT_MiniAOD_PU200.root";// f_Aug29_hadd/RelValZTT_MiniAOD_PU200.root";//../store/TwoTaus_Demetra.root"; // /data/uhussain/TwoTausEff_Aug8_hadd/GluHtoTT_PU0.root"; 
  TString fileName = "../new_store/TwoTaus_ggH_PU0_Demetra.root"; // /data/uhussain/TwoTausEff_Aug8_hadd/GluHtoTT_PU200.root"; 
  ...
  TString treePath2 = "cutBased/OrgPFTaus"; //"cutBased/ModFixedStripTaus";
  //int bins = 30;
  //double low  = -1.5;
  //double high = 1.5;
  ...
  TString GenCut= "genTauPt> 20 && abs(genTauEta) < 2.3 && dm > -1"; //(dm!=5&&dm!=6 && dm > -1)"; // < 1.5 && (dm!=5&&dm!=6 && dm > -1)";
  
  //TString GenCut1= "genTauPt > 22 && abs(genTauEta)> 2.3 && abs(genTauEta) <4.0 && (dmf!=5&&dmf!=6 && dmf > -1) && (dmf == 10) &&"+z3;
 
  TString RecoCut= "tauPt > 20 && abs(tauEta) < 2.3 && taupfTausDiscriminationByDecayModeFindingNewDMs>0.5 && " + GenCut;//taupfTausDiscriminationByDecayModeFinding==1 && tauChargedIsoPtSum<2.5 &&" + GenCut;//tauChargedIsoPtSum<2.5 && taupfTausDiscriminationByDecayModeFinding>-1 &&" + GenCut; //<1.5 && taupfTausDiscriminationByDecayModeFinding==1 &&" + GenCut;
  ...
  TString outFileName = "eff_plot_RelVal_PU0_PU200_eta2.3_newDM"; // "plot-HTT-PT-pu0-200_olddmf";
