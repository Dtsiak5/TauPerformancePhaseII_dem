...
void plotTwoTauClopperEfficiency_eta(){
  ...
  TString RecoCut= "tauPt > 20 && abs(tauEta)<3.0 && taupfTausDiscriminationByDecayModeFinding==1 && tauChargedIsoPtSum<2.5 &&" + GenCut;//tauChargedIsoPtSum<2.5 &&
  ...
  TString outFileName = "Misidendification_plot_eta_2.5";
