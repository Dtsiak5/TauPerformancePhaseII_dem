...
void ptoverpt(){
  ...
  TString GenCut= "genTauPt> 20 && abs(genTauEta) < 2.3 && (dm!=5&&dm!=6 && dm > -1)"; // < 1.5 && (dm!=5&&dm!=6 && dm > -1)";
  
  //TString GenCut1= "genTauPt > 22 && abs(genTauEta)> 2.3 && abs(genTauEta) <4.0 && (dmf!=5&&dmf!=6 && dmf > -1) && (dmf == 10) &&"+z3;
 
  TString RecoCut= "tauPt > 20 && abs(tauEta) < 2.3 && taupfTausDiscriminationByDecayModeFinding==1 &&" + GenCut;//tauChargedIsoPtSum<2.5 && taupfTausDiscriminationByDecayModeFinding>-1 &&" + GenCut; //<1.5 && taupfTausDiscriminationByDecayModeFinding==1 &&" + GenCut;
  ...
  TString outFileName = "eff_plot_RelVal_PU0_PU200_eta2.3_2.5"; // "plot-HTT-PT-pu0-200_olddmf";
