...
void plotTwoTauFakes_eta(){
  ...
  TString fileName = "../new_store/TwoTaus_QCD_PU0.root";
  //TString fileName1 = "/data/uhussain/Phase2Taus_Oct25_hadd/QCD_Flat_MiniAOD_PU140.root"; 
  TString fileName2 = "../new_store/TwoTaus_QCD_PU200.root"; //"/data/uhussain/Phase2Taus_Feb23_hadd/QCD_Flat_MiniAOD_PU200.root"; 
  ...
  TString treePath2 = "cutBased/jetOrgPFTaus"; //jetModFixedStripTaus";
  int bins = 30;
  double low  = -3.0;
  double high = 3.0;
  ...
  TString outFileName = "plot-Fakes-eta_2.5";
 ...
 /////fourth
  ...
  //mg->Add(eff_3);
  gPad->SetGrid();
// taupfTausDiscriminationByDecayModeFinding>-1 &&" + GenCut; //<1.5 && taupfTausDiscriminationByDecayModeFinding==1 &&" + GenCut; d->SetGrid();
  mg->Draw("AP");
  ...
  TLegend *leg = new TLegend(.30,.744,.67,.842,legLabel,"nbNDC");
  ...
  latex->DrawLatex(0.28,  0.95, text);
