...
void plotTwoTauClopperEfficiency_eta_new(){
  ...
  TString treePath2 = "cutBased/OrgPFTaus"; 
  ...
  TString RecoCut= "tauPt > 20 && abs(tauEta)<3.0 && taupfTausDiscriminationByDecayModeFinding==1 && tauChargedIsoPtSum<1.5 &&" + GenCut;//tauChargedIsoPtSum<2.5 &&
  ...
  TString outFileName = "Misidendification_plot_eta_1.5";
  
  //TString legLabel = "#tau_{h} from Z #rightarrow #tau #tau (RelVal)"; 
  TString legLabel = "Z #bf{#rightarrow #tau #tau (RelVal)}"; 
